...
def main():
    ...
    """
    file_path = "03_random_forest_max_depth.csv"
    ...
    if df is not None:
        ...
        plt.savefig('03_random_forest_max_depth_01.png', dpi=300)
        plt.show()
        ...
        plt.savefig('03_random_forest_max_depth_02.png', dpi=300)
        plt.show()
        ...
        plt.savefig('03_random_forest_max_depth_03.png', dpi=300, bbox_inches='tight')
        plt.show()
