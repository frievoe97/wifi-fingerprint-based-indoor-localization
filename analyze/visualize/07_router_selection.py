...
def plot_bar(data, algorithm, ax, title, x_order, strategy_col):
    ...
    plot = sns.barplot(data=data,
                       ...
                       order=x_order,
                       palette=sns.color_palette("viridis", 2), errorbar=None)
    ax.set_title(title)
    ax.set_xlabel('')
...
def plot_line(data, algorithm, ax, title, x_order, strategy_col):
    ...
    sns.lineplot(data=data,
                 ...
                 hue_order=x_order, ax=ax, palette=sns.color_palette("viridis", 2), errorbar=None)
    ax.set_title(title)
...
def main():
    ...
    """
    strategy_col = 'router_selection'
    hue_order = ["all", "eduroam"]
    file_path = "07_router_selection.csv"
    ...
    if df is not None:
        ...
        fig.legend(handles, labels, loc='lower center', ncol=len(hue_order), bbox_to_anchor=(0.12, 0.01))
