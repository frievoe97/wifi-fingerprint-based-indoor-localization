...
def main():
    ...
    """
    file_path = "05_best_parameters_random_forest.csv"
    ...
    if df is not None:
        ...
        plt.savefig('05_best_parameters_random_forest_02.png', dpi=300)
        plt.show()
        ...
        plt.savefig('05_best_parameters_random_forest_03.png', dpi=300, bbox_inches='tight')
        plt.show()

        avg_correct_percent.to_csv('05_best_parameters_random_forest_04.csv', index=False)
